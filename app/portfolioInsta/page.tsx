...
const DesignsPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#030303] text-white py-20 px-4 selection:bg-cyan-500/30">
      ...
      <header className="max-w-7xl mx-auto mb-20 border-l-2 border-white/10 pl-8">
        <motion.div
        ...
        >
          DESIGN<span className="text-white/10">.GALLERY</span>
        </motion.h1>
        
        <p className="mt-6 text-gray-500 font-medium max-w-xl text-sm leading-relaxed uppercase tracking-wider">
