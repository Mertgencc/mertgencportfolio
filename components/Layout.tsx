...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => setIsLoading(false), 3000); // 3 saniye ideal süre
    return () => {
        ...
        {isLoading && (
          ...
          >
            <div className="flex flex-col items-center gap-6">
              ...
              >
                <span className="text-[10px] font-mono text-white/80 tracking-[0.6em] uppercase">
                  MERT GENÇ
                </span>
