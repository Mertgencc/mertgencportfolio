...
<motion.div
  ...
  viewport={{ once: true }}
  transition={{ duration: 0.8 }}
  className="bg-[#111] bg-opacity-80 backdrop-blur-xl py-12 sm:py-16 rounded-3xl mx-2 sm:mx-4 mt-8 mb-8 border border-white/5"
>
  <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 text-center">
    {/* Orijinal Sade Başlık */}
    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
      Hemen İzle
    </h2>
    <p className="text-base sm:text-lg text-gray-300 mb-12 max-w-2xl mx-auto font-light">
      Projelerimi takip etmek ve eğitim içeriklerime göz atmak için videolarımı izleyebilir 
      veya sosyal medya üzerinden iletişime geçebilirsiniz.
    </p>

    {/* Video Grid - Açıklamalar Altında */}
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto mb-16">
      {[
        { 
          id: "mGTbEARmUtU", 
          title: "3D Modelleme & Render", 
          desc: "Blender kullanarak profesyonel 3D dünyasına giriş yapın." 
        },
        { 
          id: "zPf0st3QIHs", 
          title: "Kreatif Tasarım Rehberi", 
          desc: "Canva ve modern araçlarla görsel tasarımın püf noktaları." 
        }
      ].map((video) => (
        <div key={video.id} className="group text-left">
          <a 
            href={`https://www.youtube.com/watch?v=${video.id}`}
            target="_blank" 
            rel="noopener noreferrer"
            className="block overflow-hidden rounded-xl border border-white/5 bg-black/40 transition-all hover:border-white/20 mb-4"
          >
            <div className="relative aspect-video">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 group-hover:scale-110 group-hover:bg-white group-hover:text-black transition-all duration-300">
          ...
          <div className="px-1">
            <h3 className="text-white text-base font-semibold group-hover:text-blue-500 transition-colors">
              {video.title}
            </h3>
            <p className="text-gray-500 text-sm font-light mt-1 italic">
              {video.desc}
            </p>
          </div>
        </div>
    ...
    {/* Copyright Formatı */}
    <div className="mt-8 text-gray-600 text-[11px] font-medium tracking-[0.15em] uppercase">
      Copyright © {new Date().getFullYear()} Mert Genç • Tüm Hakları Saklıdır
    </div>
  </div>
</motion.div>
